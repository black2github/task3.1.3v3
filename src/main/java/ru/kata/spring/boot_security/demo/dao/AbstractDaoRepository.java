...
public abstract class AbstractDaoRepository<T, ID> implements DaoRepository<T, ID> {
    ...
    public Optional<T> findById(ID id) {
        ...
        String query = String.format("select o from %s o where o.id = :id", getEntityName());
    ...
    public Optional<T> findByName(String name) {
        ...
        EntityGraph entityGraph = getFindEntityGraph();
        String query = String.format("select o from %s o where o.%s = :name", getEntityName(), getNameFieldName());
